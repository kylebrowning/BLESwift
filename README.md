...
other** (`Scripts/sim-to-sim-e2e.sh`, which runs locally, and on every push to `main` and every
same-repository pull request on the project's self-hosted CI runner).
